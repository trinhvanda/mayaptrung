...
//  Firebase.setWriteSizeLimit(fbdb,"tiny");
  ...
  timerID1 = timer.setInterval(30000, ngayap);
  attachInterrupt(up1, tangsl1, FALLING);
  attachInterrupt(down1, giamsl1, FALLING);
  attachInterrupt(up2, tangsl2, FALLING);
  attachInterrupt(down2, giamsl2, FALLING);
}
